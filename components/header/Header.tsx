...
function Header({
  ...
  return (
    <>
      <header>
        <div
          class={`scrollHeader top-0 bg-base-100 w-full z-50 rounded-b-2xl shadow-blg`}
        >
          <ScrollHeader />
          <Drawers menu={{ items }} searchbar={searchbar} platform={platform} />
          <div>
            <HeaderCampaignTimer
              expiresAt={headerCampaignTimer.expiresAt}
              labels={headerCampaignTimer.labels}
              text={headerCampaignTimer.text}
              link={headerCampaignTimer.link}
              ctaText={headerCampaignTimer.ctaText}
              buttons={buttons}
            />
            <TopBar
              device={device}
