  ...
  return (
    ...
    >
      ...
      <Picture preload={lcp}>
        ...
        />
        <img
          class="sm:object-cover w-full h-auto sm:h-full "
...
function Dots({ images, interval = 0 }: Props) {
  return (
    <>
      ...
      />
      <ul class="carousel justify-center col-span-full gap-3 z-10 py-2">
        {images?.map((_, index) => (
          <li class="carousel-item">
            <Slider.Dot index={index}>
              <div class="w-3 h-3 rounded-full border border-transparent group-disabled:border-gray-0 flex items-center justify-center">
                <div
                  class="bg-gray-10 w-2 h-2 rounded-full border border-transparent group-disabled:animate-progress group-disabled:bg-gray-0 group-disabled:border-gray-0 bg-gradient-to-r from-base-100 from-[length:var(--dot-progress)] to-[rgba(255,255,255,0.4)] to-[length:var(--dot-progress)]"
...
function BannerCarousel(props: Props) {
  ...
  return (
    <div
      id={id}
      class="grid grid-cols-[48px_1fr_48px] sm:grid-cols-[120px_1fr_120px] grid-rows-[1fr_48px_1fr_64px] min-h-min mb-9 full-phone:mb-6"
    >
