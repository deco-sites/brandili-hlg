...
function FilterRange(
  ...
  return (
    <div class="bg-white-0 shadow-blg-1 lg:p-3 rounded">
      <div class="flex-col min-w-64 flex gap-2 bg-white-0 w-full lg:p-3 lg:rounded">
        <div ref={slider} class="relative w-full text-center inline-block">
          ...
          <input
            ref={min}
            id={`min-${id}`}
            class="cursor-pointer absolute filter-range top-0 left-0"
            name="min"
            type="range"
            step="1"
            min={minValue}
          ...
          <input
            ref={max}
            id={`max-${id}`}
            class="cursor-pointer absolute filter-range top-0 right-0"
            name="max"
            type="range"
            step="1"
            min={minValue}
        ...
        <div class="flex justify-between items-center mt-1">
          <output class="text-xs font-normal text-gray-0">
